...
<html>
	...
	<body>
		<h1>JSTL-fmt</h1>
		<h2>formatNumber - 숫자를 콤마 단위로 출력 / 형식 지정 후 출력</h2>
		...
		<p><fmt:formatNumber value="10000000000" type="currency" /></p>
		<p><fmt:formatNumber value="10000000000" type="currency" 
		currencySymbol="$"/></p>
		...
		<p><fmt:formatDate value="${today}" type="both" 
		...
		<h2>requestEncoding - 클라이언트의 요청처리시 문자 인코딩 지정</h2>
		<fmt:requestEncoding value="UTF-8" />
		
		<h2>bundle, message - 키와 값으로 구성된 리소스 번들 파일 다루기</h2>
		<!-- 지정경로 : src/패키지명/bundle.properties -->
		<fmt:setBundle basename="nanix.bundle"/>
